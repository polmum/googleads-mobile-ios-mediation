...
@implementation GADUnityInterstitialAds {
    NSString *_placementID;
    NSString *_gameID;
    BOOL _isLoading;
    GADAdapterUnityRouter *_unityRouter;
...
- (void)getInterstitial {
    ...
    _isLoading = YES;
    _unityRouter = [[GADAdapterUnityRouter alloc] initializeWithGameID:_gameID];
    if (!_unityRouter) {
